# Reconstruction Method for zc3885_ddstar

## Source
- arXiv: 1310.1163
- Published mass: 3.8839 GeV
- Published width: 0.0248 GeV

## Method
This spectrum was reconstructed using the following procedure:

1. **Mass range**: 3.82 - 4.1 GeV
...
Seed=5338, independent Poisson sampling, different (M,Γ) from partner channel
